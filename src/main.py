...
if __package__ in (None, ""):
    ...
    from analysis.pipeline import build_groups, process_group
    from analysis.monitoring_parsing import parse_rm_log, parse_pidstat, parse_drm_blocks
    from analysis.monitoring_plots import (
        make_drm_allocation_figure,
        make_drm_cpu_assignment_figure,
        make_cpu_placement_figure,
    )
    from analysis.io_utils import write_outputs
    from analysis.staggered_parsing import discover_staggered_groups, load_staggered_group
    from analysis.staggered_plots import make_staggered_figure, make_staggered_threads_figure, make_staggered_cpu_slab_figure, make_staggered_steadystate_figure, make_staggered_cpu_assignment_figure
    from analysis.staggered_parsing import load_staggered_grants, load_staggered_drm_pins
    from analysis.cpu_util_parsing import parse_cpu_util
    from analysis.cpu_util_plots import make_cpu_util_heatmap
else:
...
def main() -> None:
    ...
    out_dir = repo_root / "output"  # outputs into ./output/<group>
